            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between space-y-8 md:space-y-0">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-x-4 flex items-center pt-2">
                        ...
                        <a href="mailto:someone@example.com" className="hover:text-gray-300">
                            <FaEnvelope size={20} />
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p className="max-w-sm text-sm leading-relaxed">
                        Jl. Palem I No.54, RT.8/RW.3,<br />
                        Petukangan Utara, Kec. Pesanggrahan, Kota Jakarta Selatan,<br />
            ...
            <img src="/bs-logo.png" alt="Bintang Survey" className="h-10" />
                    ...
                    <div className={`flex items-center `}>
                        ...
                        <div className="name flex flex-col ">
                            ...
                            <span className=" text-gray-200 text-xs">Survey Instrument&apos;s</span>
                        </div>
                    </div>
                </div>
            </div>
