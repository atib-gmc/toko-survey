      ...
      <section className="hero  bg-primary  w-full rounded-3xl p-8">
        <div className="rows flex justify-between  [&>*]:flex-1 ">
          <div className="cols  flex flex-col lg:gap-10 gap-6 ">
            ...
            <Button asChild variant={"secondary"} className="rounded-3xl lg:mt-11 self-start  h-12 p-[4px] pl-6 font-normal">
              <Link href={"/produk"} >
                Check Out Our Product    <ArrowRight className="text-white ml-2 bg-primary font-thin w-10 h-10 p-2   rounded-full text-3xl" />
              </Link>
            </Button>
          </div>
