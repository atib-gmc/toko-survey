...
export default function HomePage() {
  return (
    <main className="bg-white text-left  text-blue-900">
      {/* Hero Section */}
      <section className="relative section-hero bg-hero-bg bg-cover bg-fixed text-white text-center min-h-[80%]">
        ...
        <div className="row space-y-2">
          ...
          <p className="
           text-gray-700 text-justify ">
            <strong>Bintang Survey</strong> adalah supplier alat konstruksi yang fokus pada penyediaan alat survey tanah, GPS tracker, dan peralatan pendukung proyek.
            Kami Menyediakan Berbagai Macam Alat Survey Baru & Bekas Diantaranya :
          </p>
          ...
          <p>Dari Berbagai Merk dan Type Seperti : Ruide, Topcon, Sokkia, Leica, Nikon, Spectra, Hi Target, Alpha Geo, South, Foif Dll.</p>
        </div>
      </section>
